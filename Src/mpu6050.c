...
Kalman_t KalmanZ = { .Q_angle = 0.001f, .Q_bias = 0.003f, .R_measure = 0.03f, };
...
void MPU6050_Read_All(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct) {
	...
	DataStruct->KalmanAngleX = Kalman_getAngle(&KalmanX, roll, DataStruct->Gy,
			dt);*/

	DataStruct->KalmanAngleZ = DataStruct->KalmanAngleZ + DataStruct->Gz * dt;
