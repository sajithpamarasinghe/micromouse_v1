...
void SSD1306_printValue(int16_t x0, int16_t y0, int val) {
	if (val > 999) {
		itoa(val, printnum, 10);
		SSD1306_GotoXY(x0, y0);
		SSD1306_Puts(printnum, &Font_11x18, 1);
		SSD1306_GotoXY(x0 + 44, y0);
